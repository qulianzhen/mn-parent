package com.mn.doubleball.entity.param;
import java.io.Serializable;
/**
 * @ClassName:     DoubleBallParam.java
 * @Description:   双色球历史记录的参数类
 * 
 * @author         qlz
 * @version        1.0
 * @Date           2020-10-21 01:22:54
 */
public class DoubleBallParam implements Serializable{
	private static final long serialVersionUID = 1L;
	//查询条件...
	//主键
	private Long id;
	private String dbNo;
	private String dbDateStart;
	private String dbDateEnd;
	...
	public String getDbDateStart() {
		return dbDateStart;
	}

	public void setDbDateStart(String dbDateStart) {
		this.dbDateStart = dbDateStart;
	}

	public String getDbDateEnd() {
		return dbDateEnd;
	}

	public void setDbDateEnd(String dbDateEnd) {
		this.dbDateEnd = dbDateEnd;
	}
