...
Source Database       : mn-boot

Target Server Type    : MYSQL
Target Server Version : 50711
File Encoding         : 65001

Date: 2020-08-26 00:38:33
*/
...
CREATE TABLE `mn_article` (
  ...
  `AC_TITLE` varchar(50) NOT NULL DEFAULT '' COMMENT '文章标题',
  `AC_DESC` varchar(200) DEFAULT '' COMMENT '文章描述',
  `AC_TYPE` varchar(36) NOT NULL DEFAULT '' COMMENT '文章分类',
  `AC_CONTENT` longtext COMMENT '内容',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='文章管理';
...
CREATE TABLE `mn_article_type` (
  ...
  `TYPE_CODE` varchar(50) NOT NULL DEFAULT '' COMMENT '分类编码',
  `TYPE_DESC` varchar(200) DEFAULT '' COMMENT '分类描述',
  PRIMARY KEY (`ID`) USING BTREE
...
CREATE TABLE `mn_business_code` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `CODE_TAG` varchar(36) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `CODE_PREFIXION` varchar(36) DEFAULT '' COMMENT '前缀',
  `CODE_SUFFIX` varchar(36) DEFAULT '' COMMENT '后缀',
  `CURRENT_VAL` int(11) NOT NULL DEFAULT '0' COMMENT '当前值',
  `CODE_TYPE` int(2) NOT NULL DEFAULT '0' COMMENT '流水类型:0无,1按日流水,2按月流水,3按年流水',
  `CODE_LENGTH` int(2) DEFAULT '0' COMMENT '流水号总长度',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `CODE_DESC` varchar(50) DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='业务流水号';
...
CREATE TABLE `mn_generate_columntrans` (
  ...
  `COLUMN_TYPE` varchar(20) NOT NULL DEFAULT '' COMMENT '字段类型',
  `JAVA_TYPE` varchar(20) DEFAULT '' COMMENT 'javaBean中对应的类型',
  `JDBC_TYPE` varchar(20) DEFAULT '' COMMENT 'jdbc类型',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='代码生成-字段类型转换信息';
...
CREATE TABLE `mn_generate_db_info` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `DB_TYPE` int(2) NOT NULL DEFAULT '1' COMMENT '数据库类型 1mysql 2oracle',
  `DB_TABLE` varchar(100) NOT NULL DEFAULT '' COMMENT '表名(目前支持一次一张表)',
  `DB_USER_NAME` varchar(30) NOT NULL DEFAULT '' COMMENT '数据库用户名',
  `DB_USER_PWD` varchar(30) DEFAULT '' COMMENT '密码',
  `FTL_PATHS` varchar(255) DEFAULT '' COMMENT '模板文件本地路径，多个之间以分号分割',
  `COLUMN_SEARCH` varchar(255) DEFAULT '' COMMENT '查询字段，多个的话以分号分隔',
  `COLUMN_UPDATE` varchar(255) DEFAULT '' COMMENT '需要更新的字段，多个的话以分号分隔',
  `COLUMN_IGNORE` varchar(255) DEFAULT '' COMMENT '忽略的字段，多个以分号分隔',
  `TARGET_PATH` varchar(255) DEFAULT '' COMMENT '生成代码文件存放路径',
  `DB_URL` varchar(255) DEFAULT '' COMMENT '数据库连接URL',
  `ENTITY_NAME` varchar(30) DEFAULT '' COMMENT '实体类名',
  `TRANSLATE_TYPE` int(2) DEFAULT '1' COMMENT '转换类型1驼峰2原样',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='上次代码生成信息';
...
CREATE TABLE `mn_picture_manage` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `PIC_TITLE` varchar(50) NOT NULL DEFAULT '' COMMENT '图片标题',
  `PIC_DESC` varchar(200) NOT NULL DEFAULT '' COMMENT '图片描述',
...
CREATE TABLE `mn_student` (
  ...
  `WEIGHT` decimal(5,2) DEFAULT '0.00' COMMENT '体重',
  `CLASS_ID` varchar(36) NOT NULL COMMENT '所属班级ID',
...
CREATE TABLE `mn_sys_dict` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `DICT_TYPE` varchar(30) NOT NULL DEFAULT '' COMMENT '类别名',
  `DICT_DESC` varchar(30) DEFAULT '' COMMENT '描述',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`ID`) USING BTREE
...
CREATE TABLE `mn_sys_dict_item` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `DICT_TYPE_ID` varchar(36) NOT NULL DEFAULT '' COMMENT '所属类别',
  `QUOTE_NAME` varchar(30) NOT NULL DEFAULT '' COMMENT '引用名',
  `ITEM_NAME` varchar(30) NOT NULL DEFAULT '' COMMENT '条目名字',
  `ITEM_VALUE` varchar(30) NOT NULL DEFAULT '' COMMENT '条目值',
  `ITEM_ORDER` int(3) DEFAULT '0' COMMENT '序号',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='字典条目表';
...
CREATE TABLE `mn_sys_menu` (
  ...
  `MENU_ORDER` int(2) DEFAULT '1' COMMENT '显示序号',
  `MENU_ENABLE` int(2) DEFAULT '1' COMMENT '是否有效：0无效，1有效',
  `IS_LEFT` int(2) DEFAULT '0' COMMENT '是否是叶子节点：0否，1是',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `IS_DELETED` int(1) DEFAULT '0' COMMENT '是否删除：0不删除，1删除',
  PRIMARY KEY (`ID`) USING BTREE
...
-- ----------------------------
INSERT INTO `mn_sys_menu` VALUES ('1', '0', '业务模块', '', 'icon-standard-book', '1', '1', '1', '0', '2016-08-17 00:00:00', '2020-07-06 00:41:11', '0');
INSERT INTO `mn_sys_menu` VALUES ('2', '0', '个人中心', '', 'icon-standard-user', '1', '2', '1', '0', null, '2020-07-06 00:38:11', '0');
INSERT INTO `mn_sys_menu` VALUES ('3', '0', '系统设置', '', 'icon-standard-cog', '1', '3', '1', '0', null, '2020-07-06 00:42:14', '0');
INSERT INTO `mn_sys_menu` VALUES ('4', '1', 'API分组', 'html/apiGroup/apiGroupList.html', null, '2', '1', '1', '1', null, '2020-07-06 00:59:35', '0');
INSERT INTO `mn_sys_menu` VALUES ('5', '3', '菜单管理', 'html/sysMenu/sysMenuList.html', 'icon-standard-table', '2', '1', '1', '1', null, '2020-07-07 01:00:16', '0');
INSERT INTO `mn_sys_menu` VALUES ('6', '3', '字典管理', 'html/sysDict/sysDictList.html', 'icon-standard-report-magnify', '2', '2', '1', '1', null, '2020-07-07 01:03:15', '0');
INSERT INTO `mn_sys_menu` VALUES ('7', '3', '权限设置', null, 'icon-standard-monitor-link', '2', '3', '1', '0', null, '2020-07-07 01:05:00', '0');
INSERT INTO `mn_sys_menu` VALUES ('8', '7', '角色管理', 'html/sysRole/sysRoleList.html', 'icon-standard-group-link', '3', '1', '1', '1', null, '2020-08-04 22:08:21', '0');
INSERT INTO `mn_sys_menu` VALUES ('9', '7', '权限管理', 'html/sysPermission/sysPermissionList.html', 'icon-standard-folder-user', '3', '2', '1', '1', null, '2020-08-15 11:58:08', '0');
INSERT INTO `mn_sys_menu` VALUES ('10', '3', '用户管理', 'html/sysUser/sysUserList.html', 'icon-standard-vcard-edit', '2', '4', '1', '1', null, '2020-08-07 00:41:24', '0');

-- ----------------------------
-- Table structure for mn_sys_permission
-- ----------------------------
DROP TABLE IF EXISTS `mn_sys_permission`;
CREATE TABLE `mn_sys_permission` (
  `ID` bigint(20) NOT NULL COMMENT '主键',
  `PERMISSION_NAME` varchar(50) NOT NULL COMMENT '权限名称',
  `PERMISSION_URL` varchar(255) NOT NULL COMMENT '权限URL',
  `PERMISSION_TYPE` int(1) NOT NULL DEFAULT '0' COMMENT '0操作url 1页面元素',
  `PERMISSION_PARENT_ID` varchar(36) NOT NULL COMMENT '上级ID',
  `PERMISSION_REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `PERMISSION_ORDER` int(3) NOT NULL DEFAULT '0' COMMENT '显示序号',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='权限表';

-- ----------------------------
-- Records of mn_sys_permission
-- ----------------------------
INSERT INTO `mn_sys_permission` VALUES ('111111111111', 'API分组-查询22', 'abc11', '0', '4', '测试一下', '2020-08-17 01:11:28', '2020-08-24 00:41:06', '0', '1');
INSERT INTO `mn_sys_permission` VALUES ('2222222222222', 'API分组-打印按钮', 'ddd', '0', '4', '测试', '2020-08-17 01:13:11', '2020-08-24 00:41:14', '0', '2');
INSERT INTO `mn_sys_permission` VALUES ('493623593318617088', '角色222', '1321321', '1', '8', '321321', '2020-08-20 00:45:01', '2020-08-20 00:45:01', '0', '3');
INSERT INTO `mn_sys_permission` VALUES ('493623923309678592', '3213213', '321321', '0', '8', '321321321', '2020-08-20 00:46:20', '2020-08-20 00:46:20', '0', '3');
...
INSERT INTO `mn_sys_role` VALUES ('3', '角色002', '0', '备注002111', null, '2020-08-07 00:13:47', '0');
INSERT INTO `mn_sys_role` VALUES ('488903342047760384', 'wode', '0', 'beishuzz', '2020-08-07 00:08:26', null, '0');
...
CREATE TABLE `mn_sys_user` (
  ...
  `EMPLOYYER_ID` varchar(36) DEFAULT NULL COMMENT '对应员工的ID',
  `ISLOCK` int(1) NOT NULL DEFAULT '0' COMMENT '是否锁定 0否 1是',
  `PHOTO` varchar(255) DEFAULT NULL COMMENT '头像',
  `USER_STATUS` int(1) DEFAULT NULL COMMENT '用户状态，备用',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `IS_DELETED` int(1) NOT NULL DEFAULT '0' COMMENT '是否删除：0未删除，1删除',
...
INSERT INTO `mn_sys_user` VALUES ('489271055018496000', 'abc', 'nihao', '1c1ac788efb0a10675cdec473d3721a3', null, '0', null, null, 'fdsaf', '2020-08-08 00:29:35', null, '0', null);
INSERT INTO `mn_sys_user` VALUES ('491406269287108608', '2321', '3213', '10a16981f961f51befeeefc009849e15', null, '0', null, null, '321321', '2020-08-13 21:54:10', null, '0', null);
INSERT INTO `mn_sys_user` VALUES ('491406396668121088', 'efe', 'efe', '9465c203fe4903d8035d35ce21d87c1f', null, '0', null, null, 'wrewrew', '2020-08-13 21:54:40', null, '0', null);
INSERT INTO `mn_sys_user` VALUES ('495788138162163712', 'superadminmn', '超级管理员', 'edca38e8e6e56ea7201497635a5399b7', null, '0', null, null, '12312', '2020-08-26 00:06:09', null, '0', null);
...
CREATE TABLE `mn_sys_user_role` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户-角色对应表';

-- ----------------------------
-- Records of mn_sys_user_role
-- ----------------------------
INSERT INTO `mn_sys_user_role` VALUES ('491765827662647296', '491406396668121088', '2');
INSERT INTO `mn_sys_user_role` VALUES ('491765827662647297', '491406396668121088', '3');
INSERT INTO `mn_sys_user_role` VALUES ('491765827662647298', '491406396668121088', '488903342047760384');
...
CREATE TABLE `sys_role_permission` (
  ...
  `PERMISSION_TYPE` int(1) NOT NULL COMMENT '权限类型：0操作url；1页面元素 ；2菜单URL',
  PRIMARY KEY (`ID`) USING BTREE
