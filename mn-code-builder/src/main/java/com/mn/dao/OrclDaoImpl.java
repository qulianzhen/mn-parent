...
/**
 * @ClassName:     OrclDaoImpl.java
 * @Description:   查询oracle数据库得到表信息 : 待完善！！！
 * 
 * @author         qlz
 * @version        V1.0  
 ...
 */
@Repository("orclDao")
public class OrclDaoImpl extends BaseDaoImpl<BuliderColumn> implements TableDao{
	...
	@Override
	public String getPkByTableName(String tableName,String schemaName)
			throws Exception {
